    ...
    <nav @mouseleave="isDropdownOpen = false" id="header" class="w-full z-30 top-0 py-1">
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3">
            ...
            <div class="order-2 md:order-3 flex items-center" id="nav-content">
                ...
                <span v-if="cartItemCount > 0" class="bg-red-500 text-white text-xs font-bold px-2 rounded-full">{{
                    cartItemCount }}</span>
                ...
                <a class="pl-3 inline-block no-underline hover:text-black" href="/dashboard">
                    <svg class="fill-current hover:text-black" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        viewBox="0 0 24 24">
