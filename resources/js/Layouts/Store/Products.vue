<template>
    <section class="bg-white py-8">
        ...
        <div class="flex justify-center my-8">
                ...
                class="mr-2" method="get" as="button" type="button" :disabled="products.current_page == 1">
                    Previous
                </Link>
               
                <Link :href="`?page=${products.current_page + 1}`" 
                class="ml-2" method="get" as="button" type="button" :disabled="products.current_page === products.last_page">
                    Next
                </Link>
            </div>
