                            ...
                            <tbody>
                                <tr v-for="store in stores.data" :key="store.id">
                                    ...
                                    <td class="border px-4 py-2">
                                        <a :href="`/${store.id}`" target="_blank" class="text-blue-600 hover:text-blue-800 mr-2">Visit Store</a>
                                        |
                                        <a :href="`/impersonate/${store.id}`" class="text-blue-600 hover:text-blue-800 mr-2">Login As</a>
                                        |
                                        <button @click="deleteStore(store.id)" class="text-red-600 hover:text-red-800">Delete</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
